...
#include <ltbl/quadtree/DynamicQuadtree.cpp>
#include <ltbl/lighting/LightPointEmission.cpp>
#include <ltbl/lighting/LightDirectionEmission.cpp>
#include <ltbl/lighting/LightShape.cpp>
#include <ltbl/lighting/LightSystem.cpp>
